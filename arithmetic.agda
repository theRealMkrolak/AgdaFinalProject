...
only≤Divides a b b!=0 (aNeqb , b≤a) a|b = aNeqb $ a≤b&b≤a=>a=b a b (a≤b , b≤a)
  where
    c = car a|b
    ac=b = cdr a|b
    a≤b = a≤b&b=c=>a≤c a (a * c) b (c!=0&a=b=>a≤bc a a c ((λ c=0 → b!=0 $ trans (sym ac=b) (trans (cong (λ x → a * x) c=0) (n*0=0 a))) , refl) , ac=b)
